...
void process_command() {
    ...
    if (fd < 0) {
        printf("Nu pot citi fișierul de comandă\n");
        return;
    }
    ...
    if (strcmp(buffer, "stop") == 0) {
        printf("Monitor: recieved stop command, exiting in 3 seconds...\n");
        usleep(3000000);
        exit(0);
	  ...
	  printf("Format invalid. Foloseste: view_treasure hunt_id treasure_id\n");
	}
    } else {
